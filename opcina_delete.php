	...
	<div id="content-container2">
		<div id="content-container3">
			...
			if ($razina==2){
				...
				$sql="DELETE FROM OPCINA WHERE idOpcina=$sifra_opcine";
				$result=mysqli_query($conn, $sql) or die("<h2>Pogreska kod dodavanja opcina</h2>".mysqli_error($conn));
					if ($result){
					echo "<h2>Uspješno je izbrisana općina sa šifrom: <b>$sifra_opcine</b> !</h2><br>";
					IspisOpcina();
					}	
				}
			}
