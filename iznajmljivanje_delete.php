	...
	<div id="content-container2">
		<div id="content-container3">
			...
			if ($razina==2){
				...
				$sql="DELETE FROM Iznajmljivanje WHERE idIznajmljivanje=$idIznajmljivanje";
				$result=mysqli_query($conn, $sql) or die("<h2>Pogreska kod dodavanja iznajmljivanja</h2>".mysqli_error($conn));
					if ($result){
					echo "<h2>Uspješno je izbrisano iznajmljivanje sa šifrom: <b>$idIznajmljivanje</b> !</h2><br>";
					IspisIznajmljivanje();
					}	
				}
			}
